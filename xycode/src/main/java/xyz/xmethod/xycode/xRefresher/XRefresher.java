...
public class XRefresher extends LinearLayout implements FlexibleDividerDecoration.VisibilityProvider, FlexibleDividerDecoration.SizeProvider {
   ...
   private boolean addDefaultHeader = true;
    ...
    @Deprecated
    public void setup(BaseActivity activity, XAdapter adapter, boolean loadMore, OnSwipeListener swipeListener, RefreshRequest refreshRequest) {
     ...
     * @return
     */
    public RefreshSetter setup(BaseActivity activity, XAdapter adapter) {
